...
Example of how to change crawl behavior to only crawl nav links inside of a main element (the 'a' group is used to crawl urls, other groups will only show up in the page reports):
